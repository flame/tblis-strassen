...
do
    ./test_strassen -m $k -n $k -k 1024 -niter 3 -level 1 -impl 1 -seed $seed | tee stra_square_1core.m
done
...
for (( k=k_start; k<=k_end; k+=k_blocksize ))
do
    ./test_strassen -m $k -n $k -k 1024 -niter 3 -level 1 -impl 2 -seed $seed | tee stra_square_1core.m
done
echo "];" | tee stra_square_1core.m
...
for (( k=k_start; k<=k_end; k+=k_blocksize ))
do
    ./test_strassen -m $k -n $k -k 1024 -niter 3 -level 1 -impl 3 -seed $seed | tee stra_square_1core.m
done
echo "];" | tee stra_square_1core.m
...
for (( k=k_start; k<=k_end; k+=k_blocksize ))
do
    ./test_strassen -m $k -n $k -k 1024 -niter 3 -level 2 -impl 1 -seed $seed | tee stra_square_1core.m
done
echo "];" | tee stra_square_1core.m
# 2-level AB Strassen
...
for (( k=k_start; k<=k_end; k+=k_blocksize ))
do
    ./test_strassen -m $k -n $k -k 1024 -niter 3 -level 2 -impl 2 -seed $seed | tee stra_square_1core.m
done
echo "];" | tee stra_square_1core.m
...
for (( k=k_start; k<=k_end; k+=k_blocksize ))
do
    ./test_strassen -m $k -n $k -k 1024 -niter 3 -level 2 -impl 3 -seed $seed | tee stra_square_1core.m
done
echo "];" | tee stra_square_1core.m
