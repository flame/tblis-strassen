...
struct config
{
    ...
    /////////////////////////////////////////////////////////
    microkernel<stra_gemm_ukr_t> stra_gemm_ukr;
    microkernel<stra_gemm_ukr_two_t> stra_gemm_ukr_two;
    microkernel<stra_gemm_ukr_four_t> stra_gemm_ukr_four;
    ...
    /////////////////////////////////////////////////////////
    microkernel<stra_pack_nn_ukr_t> stra_pack_nn_mr_ukr;
    microkernel<stra_pack_nn_ukr_t> stra_pack_nn_nr_ukr;

    microkernel<stra_pack_two_nn_ukr_t> stra_pack_two_nn_mr_ukr;
    microkernel<stra_pack_two_nn_ukr_t> stra_pack_two_nn_nr_ukr;
    microkernel<stra_pack_four_nn_ukr_t> stra_pack_four_nn_mr_ukr;
    microkernel<stra_pack_four_nn_ukr_t> stra_pack_four_nn_nr_ukr;
    ...
    /////////////////////////////////////////////////////////
    microkernel<stra_pack_nb_ukr_t> stra_pack_nb_mr_ukr;
    microkernel<stra_pack_nb_ukr_t> stra_pack_nb_nr_ukr;
    microkernel<stra_pack_sb_ukr_t> stra_pack_sb_mr_ukr;
    microkernel<stra_pack_sb_ukr_t> stra_pack_sb_nr_ukr;

    microkernel<stra_pack_two_nb_ukr_t> stra_pack_two_nb_mr_ukr;
    microkernel<stra_pack_two_nb_ukr_t> stra_pack_two_nb_nr_ukr;
    microkernel<stra_pack_two_sb_ukr_t> stra_pack_two_sb_mr_ukr;
    microkernel<stra_pack_two_sb_ukr_t> stra_pack_two_sb_nr_ukr;

    microkernel<stra_pack_four_nb_ukr_t> stra_pack_four_nb_mr_ukr;
    microkernel<stra_pack_four_nb_ukr_t> stra_pack_four_nb_nr_ukr;
    microkernel<stra_pack_four_sb_ukr_t> stra_pack_four_sb_mr_ukr;
    microkernel<stra_pack_four_sb_ukr_t> stra_pack_four_sb_nr_ukr;
    ...
    : add_ukr(typename Traits::template add_ukr<float>()),
      ...
      /////////////////////////////////////////////////////////
      stra_gemm_ukr(typename Traits::template stra_gemm_ukr<float>()),
      stra_gemm_ukr_two(typename Traits::template stra_gemm_ukr_two<float>()),
      stra_gemm_ukr_four(typename Traits::template stra_gemm_ukr_four<float>()),
      ...
      /////////////////////////////////////////////////////////
      stra_pack_nn_mr_ukr(typename Traits::template stra_pack_nn_mr_ukr<float>()),
      stra_pack_nn_nr_ukr(typename Traits::template stra_pack_nn_nr_ukr<float>()),

      stra_pack_two_nn_mr_ukr(typename Traits::template stra_pack_two_nn_mr_ukr<float>()),
      stra_pack_two_nn_nr_ukr(typename Traits::template stra_pack_two_nn_nr_ukr<float>()),
      stra_pack_four_nn_mr_ukr(typename Traits::template stra_pack_four_nn_mr_ukr<float>()),
      stra_pack_four_nn_nr_ukr(typename Traits::template stra_pack_four_nn_nr_ukr<float>()),
      ...
      /////////////////////////////////////////////////////////
      stra_pack_nb_mr_ukr(typename Traits::template stra_pack_nb_mr_ukr<float>()),
      stra_pack_nb_nr_ukr(typename Traits::template stra_pack_nb_nr_ukr<float>()),
      stra_pack_sb_mr_ukr(typename Traits::template stra_pack_sb_mr_ukr<float>()),
      stra_pack_sb_nr_ukr(typename Traits::template stra_pack_sb_nr_ukr<float>()),

      stra_pack_two_nb_mr_ukr(typename Traits::template stra_pack_two_nb_mr_ukr<float>()),
      stra_pack_two_nb_nr_ukr(typename Traits::template stra_pack_two_nb_nr_ukr<float>()),
      stra_pack_two_sb_mr_ukr(typename Traits::template stra_pack_two_sb_mr_ukr<float>()),
      stra_pack_two_sb_nr_ukr(typename Traits::template stra_pack_two_sb_nr_ukr<float>()),

      stra_pack_four_nb_mr_ukr(typename Traits::template stra_pack_four_nb_mr_ukr<float>()),
      stra_pack_four_nb_nr_ukr(typename Traits::template stra_pack_four_nb_nr_ukr<float>()),
      stra_pack_four_sb_mr_ukr(typename Traits::template stra_pack_four_sb_mr_ukr<float>()),
      stra_pack_four_sb_nr_ukr(typename Traits::template stra_pack_four_sb_nr_ukr<float>()),
