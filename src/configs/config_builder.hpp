...
#define TBLIS_CONFIG_UKR4(config, mat, name, type, S,D,C,Z, def_ker) \
    template <typename T> struct name : static_microkernel<T, \
        type<   float>, TBLIS_GET_VALUE_OR_DEFAULT(S,(def_ker<config,   float,mat,N>)), \
        type<  double>, TBLIS_GET_VALUE_OR_DEFAULT(D,(def_ker<config,  double,mat,N>)), \
        type<scomplex>, TBLIS_GET_VALUE_OR_DEFAULT(C,(def_ker<config,scomplex,mat,N>)), \
        type<dcomplex>, TBLIS_GET_VALUE_OR_DEFAULT(Z,(def_ker<config,dcomplex,mat,N>))> {};
...
///////////////////////////////////////////////
#define TBLIS_STRA_CONFIG_GEMM_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR2(this_config, stra_gemm_ukr, stra_gemm_ukr_t, S,D,C,Z, stra_gemm_ukr_def)
#define TBLIS_STRA_CONFIG_GEMM_UKR_TWO(S,D,C,Z) \
    TBLIS_CONFIG_UKR2(this_config, stra_gemm_ukr_two, stra_gemm_ukr_two_t, S,D,C,Z, stra_gemm_ukr_two_def)
#define TBLIS_STRA_CONFIG_GEMM_UKR_FOUR(S,D,C,Z) \
    TBLIS_CONFIG_UKR2(this_config, stra_gemm_ukr_four, stra_gemm_ukr_four_t, S,D,C,Z, stra_gemm_ukr_four_def)


///////////////////////////////////////////////
#define TBLIS_STRA_CONFIG_PACK_NN_MR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_A, stra_pack_nn_mr_ukr, stra_pack_nn_ukr_t, S,D,C,Z, stra_pack_nn_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_NN_NR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_B, stra_pack_nn_nr_ukr, stra_pack_nn_ukr_t, S,D,C,Z, stra_pack_nn_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_TWO_NN_MR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_A, stra_pack_two_nn_mr_ukr, stra_pack_two_nn_ukr_t, S,D,C,Z, stra_pack_two_nn_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_TWO_NN_NR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_B, stra_pack_two_nn_nr_ukr, stra_pack_two_nn_ukr_t, S,D,C,Z, stra_pack_two_nn_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_FOUR_NN_MR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_A, stra_pack_four_nn_mr_ukr, stra_pack_four_nn_ukr_t, S,D,C,Z, stra_pack_four_nn_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_FOUR_NN_NR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_B, stra_pack_four_nn_nr_ukr, stra_pack_four_nn_ukr_t, S,D,C,Z, stra_pack_four_nn_ukr_def)
...
///////////////////////////////////////////////
#define TBLIS_STRA_CONFIG_PACK_NB_MR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_A, stra_pack_nb_mr_ukr, stra_pack_nb_ukr_t, S,D,C,Z, stra_pack_nb_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_NB_NR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_B, stra_pack_nb_nr_ukr, stra_pack_nb_ukr_t, S,D,C,Z, stra_pack_nb_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_SB_MR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_A, stra_pack_sb_mr_ukr, stra_pack_sb_ukr_t, S,D,C,Z, stra_pack_sb_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_SB_NR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_B, stra_pack_sb_nr_ukr, stra_pack_sb_ukr_t, S,D,C,Z, stra_pack_sb_ukr_def)

#define TBLIS_STRA_CONFIG_PACK_TWO_NB_MR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_A, stra_pack_two_nb_mr_ukr, stra_pack_two_nb_ukr_t, S,D,C,Z, stra_pack_two_nb_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_TWO_NB_NR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_B, stra_pack_two_nb_nr_ukr, stra_pack_two_nb_ukr_t, S,D,C,Z, stra_pack_two_nb_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_TWO_SB_MR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_A, stra_pack_two_sb_mr_ukr, stra_pack_two_sb_ukr_t, S,D,C,Z, stra_pack_two_sb_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_TWO_SB_NR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_B, stra_pack_two_sb_nr_ukr, stra_pack_two_sb_ukr_t, S,D,C,Z, stra_pack_two_sb_ukr_def)

#define TBLIS_STRA_CONFIG_PACK_FOUR_NB_MR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_A, stra_pack_four_nb_mr_ukr, stra_pack_four_nb_ukr_t, S,D,C,Z, stra_pack_four_nb_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_FOUR_NB_NR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_B, stra_pack_four_nb_nr_ukr, stra_pack_four_nb_ukr_t, S,D,C,Z, stra_pack_four_nb_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_FOUR_SB_MR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_A, stra_pack_four_sb_mr_ukr, stra_pack_four_sb_ukr_t, S,D,C,Z, stra_pack_four_sb_ukr_def)
#define TBLIS_STRA_CONFIG_PACK_FOUR_SB_NR_UKR(S,D,C,Z) \
    TBLIS_CONFIG_UKR3(this_config, matrix_constants::MAT_B, stra_pack_four_sb_nr_ukr, stra_pack_four_sb_ukr_t, S,D,C,Z, stra_pack_four_sb_ukr_def)
...
struct config_template
{
    ...
    TBLIS_STRA_CONFIG_GEMM_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_GEMM_UKR_TWO(_,_,_,_)
    TBLIS_STRA_CONFIG_GEMM_UKR_FOUR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_NN_MR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_NN_NR_UKR(_,_,_,_)

    TBLIS_STRA_CONFIG_PACK_TWO_NN_MR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_TWO_NN_NR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_FOUR_NN_MR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_FOUR_NN_NR_UKR(_,_,_,_)
    ...
    TBLIS_STRA_CONFIG_PACK_NB_MR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_NB_NR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_SB_MR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_SB_NR_UKR(_,_,_,_)

    TBLIS_STRA_CONFIG_PACK_TWO_NB_MR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_TWO_NB_NR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_TWO_SB_MR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_TWO_SB_NR_UKR(_,_,_,_)

    TBLIS_STRA_CONFIG_PACK_FOUR_NB_MR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_FOUR_NB_NR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_FOUR_SB_MR_UKR(_,_,_,_)
    TBLIS_STRA_CONFIG_PACK_FOUR_SB_NR_UKR(_,_,_,_)
