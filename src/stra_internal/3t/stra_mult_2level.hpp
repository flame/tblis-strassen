#ifndef _TBLIS_STRA_INTERNAL_3T_MULT_2LEVEL_HPP_
#define _TBLIS_STRA_INTERNAL_3T_MULT_2LEVEL_HPP_
...
enum impl_t {BLIS_BASED, BLAS_BASED, REFERENCE, STRA_NAIVE, STRA_AB};
extern impl_t impl;
