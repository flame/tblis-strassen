         ...
         const std::vector<stride_type>& stride_B_AB)
{
    if (len_A.empty() && len_B.empty() && !len_AB.empty())
    {
        ...
        //std::cout << "stride_A0: " << stride_A0 << std::endl;
        //PRINT_VECTOR( stride_A1 )

        stride_type stride_B0 = stride_B_AB[0];
        std::vector<stride_type> stride_B1(stride_B_AB.begin()+1,
                                           stride_B_AB.end());

        //std::cout << "stride_B0: " << stride_B0 << std::endl;
        //PRINT_VECTOR( stride_B1 )
        ...
        //std::cout << "len0:" << len0 << "; n: " << n << std::endl;
        //std::cout << "m_min:" << m_min << "; m_max: " << m_max << "; n_min: " << n_min << "; n_max:" << n_max << std::endl;
