                   ...
                   const std::vector<stride_type>& stride_C_BC)
{
    ...
    //Switch to MKL as a baseline performance
                   ...
                   const std::vector<stride_type>& stride_C_BC)
{
    ...
    //std::cout << "at:length(0):" << std::endl;
    //std::cout << at.length(0) << std::endl;
    //std::cout << "at:length(1):" << std::endl;
    //std::cout << at.length(1) << std::endl;

    //std::cout << "at:stride(0):" << std::endl;
    //std::cout << at.stride(0) << std::endl;
    //std::cout << "at:stride(1):" << std::endl;
    //std::cout << at.stride(1) << std::endl;
    ...
    //PRINT_VECTOR( stl_ext::permuted(len_AC, reorder_AC) )
    //PRINT_VECTOR( stl_ext::permuted(stride_A_AC, reorder_AC) )
    ...
    //std::cout << "internal/mult:" << std::endl;
