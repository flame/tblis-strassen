...
void stra_tblis_matrix_mult(const tblis_comm* comm, const tblis_config* cfg,
                            ...
                            tblis_matrix* C)
{
    //printf( "Enter 3m/stra_tblis_matrix_mult\n" );
...
void stra_tblis_matrix_mult_naive(const tblis_comm* comm, const tblis_config* cfg,
                            ...
                            tblis_matrix* C)
{
    //printf( "Enter 3m/stra_tblis_matrix_mult_naive\n" );
    TBLIS_ASSERT(A->m == C->m);
    TBLIS_ASSERT(B->n == C->n);
    TBLIS_ASSERT(A->n == B->m);
    TBLIS_ASSERT(A->type == B->type);
    ...
    TBLIS_WITH_TYPE_AS(A->type, T,
    {
        ...
        {
            parallelize_if(internal::stra_mult_naive<T>, comm, get_config(cfg),
                           C->m, C->n, A->n,
                           alpha, A->conj, static_cast<const T*>(A->data), A->rs, A->cs,
                                  B->conj, static_cast<const T*>(B->data), B->rs, B->cs,
                            beta, C->conj,       static_cast<T*>(C->data), C->rs, C->cs);
...
void stra_tblis_matrix_mult_ab(const tblis_comm* comm, const tblis_config* cfg,
                            ...
                            tblis_matrix* C)
{
    //printf( "Enter 3m/stra_tblis_matrix_mult_ab\n" );
    TBLIS_ASSERT(A->m == C->m);
    TBLIS_ASSERT(B->n == C->n);
    TBLIS_ASSERT(A->n == B->m);
    TBLIS_ASSERT(A->type == B->type);
    ...
    TBLIS_WITH_TYPE_AS(A->type, T,
    {
        ...
        {
            parallelize_if(internal::stra_mult_ab<T>, comm, get_config(cfg),
                           C->m, C->n, A->n,
                           alpha, A->conj, static_cast<const T*>(A->data), A->rs, A->cs,
                                  B->conj, static_cast<const T*>(B->data), B->rs, B->cs,
                            beta, C->conj,       static_cast<T*>(C->data), C->rs, C->cs);
